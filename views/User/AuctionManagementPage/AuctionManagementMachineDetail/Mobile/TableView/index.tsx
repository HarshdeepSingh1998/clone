...
import NoProductView from 'views/User/AuctionManagementPage/AuctionManagementMachineDetail/Mobile/NoProductView'
import {
  BidTableData,
  generateBiddingTableData,
  biddingColumns
} from 'views/User/AuctionManagementPage/AuctionManagementMachineDetail/Mobile/data'
import {
  TableContainer,
  TableContent,
  HeaderTitle,
  ...
  TableList,
  HeaderText
} from '@/styles/Views/User/AuctionManagementPage/AuctionManagementMachineDetail/Mobile/Table'
